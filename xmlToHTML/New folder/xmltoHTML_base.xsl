...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		<div id="content">
			<link rel="stylesheet" href="xmlTransform.css"/>
			<script>
				{
				"title":
		...
		<xsl:template name="entry-body-widget">
			...
			<xsl:if test="extension-points">
				<section id="extension-points">
					...
					<p>
						The <xsl:value-of select="$widget-name"/> widget is built with the <a href="http://api.jqueryui.com/jQuery.widget/">widget factory</a> and can be extended. When extending widgets, you have the ability to override or add to the behavior of existing methods. The following methods are provided as extension points	with the same API stability as the <a href="#methods">plugin methods</a> listed	above. For more information on widget extensions, see <a href="http://learn.jquery.com/jquery-ui/widget-factory/extending-widgets/">Extending Widgets with the Widget Factory</a>.
					</p>
					<hr/>
